...
Qpmlr = listLHS{11};
Qpmli = listLHS{12};
C1tmp = listLHS{13}; % coupling matrix
C2tmp = listLHS{14};
...
Hcavr = Hcavr(FEmatrices.cavity_nodes,FEmatrices.cavity_nodes);
Hcavi = Hcavi(FEmatrices.cavity_nodes,FEmatrices.cavity_nodes);
Hcav = Hcavr+1i*Hcavi;
Qcavr = Qcavr(FEmatrices.cavity_nodes,FEmatrices.cavity_nodes);
Qcavi = Qcavi(FEmatrices.cavity_nodes,FEmatrices.cavity_nodes);
Qcav = Qcavr+1i*Qcavi;
