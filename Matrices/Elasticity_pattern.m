function FEmatrices = Elasticity_pattern(FEmatrices,listLHS,param,FILENAME)
...
for ii=1:length(FEmatrices.embedding)
    Kr(FEmatrices.embedding(ii),FEmatrices.embedding(ii)) = 1e30;
end
